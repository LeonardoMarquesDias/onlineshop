...
const backgrounds = {
  iPhone11ProBg: "iPhone11Pro:bg-[url('/prenatalin/iPhone11Pro.png')]",
  iPhone12ProMaxBg: "iPhone12ProMax:bg-[url('/prenatalin/iPhone12ProMax.png')]",
  iPhone13miniBg: "iPhone13mini:bg-[url('/prenatalin/iPhone13mini.png')]",
  iPhone13ProBg: "iPhone13Pro:bg-[url('/prenatalin/iPhone13Pro.png')]",
  iPhone15ProBg: "iPhone15Pro:bg-[url('/prenatalin/iPhone15Pro.png')]",
  iPhone15ProMaxBg: "iPhone15ProMax:bg-[url('/prenatalin/iPhone15ProMax.png')]",
  iPadminiBg: "iPadmini:bg-[url('/prenatalin/iPadmini.png')]",
  iPadBg: "iPad:bg-[url('/prenatalin/iPad.png')]",
  iPadPro11Bg: "iPadPro11:bg-[url('/prenatalin/iPadPro11.png')]",
  iPadAir5Bg: "iPadAir5:bg-[url('/prenatalin/iPadAir5.png')]",
  MacbookAirM2Bg: "MacbookAirM2:bg-[url('/prenatalin/MacbookAirM2.png')]",
  MacbookPro16Bg: "MacbookPro16:bg-[url('/prenatalin/MacbookPro16.png')]",
  iMac24Bg: "iMac24:bg-[url('/prenatalin/iMac24.png')]",
  MacbookAirBg: "MacbookAir:bg-[url('/prenatalin/MacbookAir.png')]",
  LaptopBg: "Laptop:bg-[url('/prenatalin/Laptop.png')]",
  Desktop1Bg: "Desktop1:bg-[url('/prenatalin/Desktop1.png')]",
  Desktop2Bg: "Desktop2:bg-[url('/prenatalin/Desktop2.png')]",
};
